...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_arm.setDefaultCommand(getcoolcommand());
    ...
    // joystickAButton
    //  .onTrue(new InstantCommand(() -> m_arm.setAngle(45.0 + (-m_controller.getRawAxis(3) * 45)), m_arm))  vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
  ...
  public Command  getcoolcommand() {
    return new coolcommand(
        m_arm, () -> (-m_controller.getRawAxis(3) * 45 + 45));
  //      -m_controller.getRawAxis(3)* 90);
}
}
